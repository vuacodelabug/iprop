                    ...
                    <div class="card" id="invoiceList">
                        <div class="card-header border-0">
                            <div class="d-flex align-item-center">
                                <h5 class="card-title mb-0 flex-grow-1">Loại phòng</h5>
                                <div class="flex-shrink-0">
                                    <div class="d-flex gap-2 flex-wrap">
                                        <button type="button" class="btn btn-secondary btn-create"><i
                                                class="ri-add-line align-bottom me-1"></i>Thêm loại phòng</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                                ...
                                <div class="table-responsive table-card">
                                    <table class="table " id="invoiceTable">
                                        ...
                                        <tbody class="list align-middle" id="invoice-list-data">
                                            ...
                                            @if (isset($typeapartments) and count($typeapartments) > 0)
                                                @foreach ($typeapartments as $typeapartment)
                                                    <tr id="item{{$typeapartment->id}}">
                                                        <td>{{ $typeapartment->id }}</td>
                                                        <td id="data_name{{ $typeapartment->id }}"
                                                            data-name="{{ $typeapartment->name }}">
                                                            {{ $typeapartment->name }}
                                                        </td>
                                                        <td id="data_description{{ $typeapartment->id }}">
                                                            {{ $typeapartment->description }}
                                                        </td>
                                                        <td class="text-center">
                                                            @if ($typeapartment->status == '1')
                                                        ...
                                                        <td>
                                                            <div class="d-flex gap-2">
                                                                <button type="button" data-id="{{ $typeapartment->id }}"
                                    ...
                                    @if (!isset($typeapartments) or count($typeapartments) == 0)
                                        <div class="noresult">
                            ...
                            <div id="component">
                                ...
                                @include('pages.typeapartment.modal.create')
                            </div>
                        </div>
                    </div>
