            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-item-center justify-content-between">
                        <h4 class="mb-sm-0">Danh sách tiện ích </h4>
                    ...
                    <div class="card" id="invoiceList">
                        <div class="card-header border-0">
                            <div class="d-flex align-item-center">
                                <h5 class="card-title mb-0 flex-grow-1">Tiện ích </h5>
                                <div class="flex-shrink-0">
                                    <div class="d-flex gap-2 flex-wrap">
                                        <button type="button" class="btn btn-secondary btn-create"><i
                                                class="ri-add-line align-bottom me-1"></i>Thêm tiện ích </button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                                ...
                                <div class="table-responsive table-card">
                                    <table class="table " id="invoiceTable">
                                        ...
                                        <tbody class="list align-middle" id="invoice-list-data">
                                            ...
                                            @if (isset($utilitiess) and count($utilitiess) > 0)
                                                @foreach ($utilitiess as $utilities)
                                                    <tr id="item{{$utilities->id}}">
                                                        <td>{{ $utilities->id }}</td>
                                                        <td id="data_name{{ $utilities->id }}"
                                                            data-name="{{ $utilities->name }}">
                                                            {{ $utilities->name }}
                                                        </td>
                                                        <td id="data_description{{ $utilities->id }}">
                                                        ...
                                                        <td>
                                                            <div class="d-flex gap-2">
                                                                <button type="button" data-id="{{ $utilities->id }}"
                                    ...
                                    @if (!isset($utilitiess) or count($utilitiess) == 0)
                                        <div class="noresult">
                            ...
                            <div id="component">
                                ...
                                @include('pages.utilities.modal.create')
                            </div>
                        </div>
                    </div>
