                    ...
                    <div class="card" id="invoiceList">
                        <div class="card-header border-0">
                            <div class="d-flex align-item-center">
                                <h5 class="card-title mb-0 flex-grow-1">Dịch vụ</h5>
                        ...
                        <div class="card-body">
                            <div>
                                <div class="table-responsive table-card">
                                            ...
                                            @if (isset($services) and count($services) > 0)
                                                @foreach ($services as $service)
                                                    <tr id="item{{$service->id}}">
                                                        <td>{{ $service->id }}</td>
                                                        <td id="data_name{{ $service->id }}"
                                                            data-name="{{ $service->name }}">
                                                            {{ $service->name }}
                                                        </td>
                                                        <td id="data_description{{ $service->id }}">
                                                            {{ $service->description }}
                                                        </td>
                                    ...
                                    @if (!isset($services) or count($services) == 0)
                                        <div class="noresult">
