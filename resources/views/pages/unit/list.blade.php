                    ...
                    <div class="card" id="invoiceList">
                        <div class="card-header border-0">
                            <div class="d-flex align-item-center">
                                <h5 class="card-title mb-0 flex-grow-1">Đơn vị</h5>
                                <div class="flex-shrink-0">
                                    <div class="d-flex gap-2 flex-wrap">
                                        <button type="button" class="btn btn-secondary btn-create"><i
                                                class="ri-add-line align-bottom me-1"></i>Thêm đơn vị</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div>
                                <div class="table-responsive table-card">
                                        ...
                                        <tbody class="list align-middle" id="invoice-list-data">
                                            ...
                                            @if (isset($units) and count($units) > 0)
                                                @foreach ($units as $unit)
                                                    <tr id="item{{$unit->id}}">
                                                        <td>{{ $unit->id }}</td>
                                                        <td id="data_name{{ $unit->id }}"
                                                            data-name="{{ $unit->name }}">
                                                            {{ $unit->name }}
                                                        </td>
                                                        <td id="data_description{{ $unit->id }}">
                                                            {{ $unit->description }}
                                                        </td>
                                    ...
                                    @if (!isset($units) or count($units) == 0)
                                        <div class="noresult">
